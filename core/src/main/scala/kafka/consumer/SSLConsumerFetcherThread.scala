...
class SSLConsumerFetcherThread(name: String,
  ...
  protected def fetch(fetchRequest: FetchRequest): Seq[(TopicPartition, PartitionData)] = {
    ...
    clientResponse.responseBody.asInstanceOf[FetchResponse].responseData.asScala.toSeq.map { case (key, value) =>
...
object SSLConsumerFetcherThread {
  ...
  class PartitionData(val underlying: FetchResponse.PartitionData) extends AbstractFetcherThread.PartitionData {
